...
namespace PhonyClubDenmark.Business.Rendering
{
    ...
    public class ContentAreaRowBalancer
    {
        ...
        public ContentAreaRowBalancer(TemplateResolver templateResolver)
        {
            _templateResolver = templateResolver;
        }

        /* Changed from IContent to ContentAreaItem*/
        public virtual IEnumerable<List<RowItem>> GetContentAreaRows(IEnumerable<ContentAreaItem> contents, HttpContextBase httpContext, string tag)
        {
